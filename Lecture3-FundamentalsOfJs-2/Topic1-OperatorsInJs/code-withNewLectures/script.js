...
d += 2;
console.log(d);
// V.V.IMP = all the other augmented assignment type operators works in the same way as (addition) augmented assignment operator:acc to there arithmetic-operation properties:
