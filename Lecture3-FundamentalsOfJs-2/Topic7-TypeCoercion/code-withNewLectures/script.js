...
// -> 1 = Addition:if we use addition operator on one number and one string value:then the number value's data-type gonna get converted into the form of string instead of string gonna get converted into the form of number:
