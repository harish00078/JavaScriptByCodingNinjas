...
// - Instead, zeros are filled from the left:This is why we get a large positive number (2147483644) instead of a negative number:because the negative-number are stored in form of two's complement format:that why we get the large positive number:
